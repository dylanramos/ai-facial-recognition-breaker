...
Les prochaines sections de ce document résument les résultats des différentes recherches effectuées, les choix de conception et de développement ainsi que les résultats finaux de ce travail. Celles-ci se référent aux différents #link("../rapports-detailles")[#underline("rapports détaillés")] joints en annexe qui présentent les informations de manière plus approfondie.
