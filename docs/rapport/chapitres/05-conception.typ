...
Pour la modification du document d'identité, les modèles de type *Text-to-Image* ne sont pas adaptés, il faut utiliser les modèles de type *Image-to-Image* comme le démontre le chap ????.
