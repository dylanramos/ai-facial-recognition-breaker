...
Avec l'essor de l'intelligence artificielle, il est désormais possible de générer des contenus multimédia ultraréalistes à la demande, ce qui ouvre la porte à de nouvelles formes d'attaques contre les systèmes de vérification d'identité en ligne.
...
#include "chapitres/00-table-des-matieres.typ"
#pagebreak(to: "odd")
...
#include "chapitres/08-attaques-echouees.typ"
#pagebreak(to: "odd")
