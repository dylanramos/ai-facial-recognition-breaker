...
def generate_video_grok_imagine(
    prompt: str, duration: int, aspect_ratio: str, image_urls: list[str]
) -> str:
    """
...
def generate_video_seedance_2_0(
    prompt: str, duration: int, aspect_ratio: str, image_urls: list[str]
) -> str:
    """
...
def edit_image_grok_imagine(prompt: str, image_urls: list[str]) -> str:
    """
